    ...
    <div class="container">
        ...
        <div class="main-content">
            ...
            <table id="main">
                <tr>
                    <td id="header">
                        <h1>Happily Adopted Dogs Data</h1>
                ...
                <tr>
                    <td>
                        <table>
                            <tr>
                                <th width="15%">Adopter Name</th>
                                <th width="20%">Adopter Email</th>
                                <th width="20%">Adopter Phone_No.</th>
                                <th width="10%">Adoption_Date</th>
                                <th width="15%">Dog Name</th>
                                <th width="15%">Dog Breed</th>
            ...
            <script type="text/javascript">
                $(document).ready(function () {
                    ...
                    function loadTable() {
                        $.ajax({
                            url: 'http://localhost/bhoorifoundation/admin/apis/api-fetch-all.php?table=adopted_dog',
                            type: "GET",
                            success: function (data) {
                                ...
                                if (data.length > 0) {
                                    ...
                                    $.each(data, function (index, item) {
                                        ...
                                        html += "<td>" + item.adopter_email + "</td>";
                                        html += "<td>" + item.adopter_phone + "</td>";
                                        html += "<td>" + item.adoption_date + "</td>";
                                        html += "<td>" + item.dog_name + "</td>";
                    ...
                    $(document).on("click", ".delete-btn", function () {
                        if (confirm("Do you really want to delete this record?")) {
                            ...
                            var tableName = "adopted_dog"; // Set the correct table name here
                    ...
                    $("#search").on("keyup", function () {
                        ...
                        $.ajax({
                            url: 'http://localhost/bhoorifoundation/admin/apis/api-search.php?table=adopted_dog&search=' + search_term,
                            type: "GET",
                            success: function (data) {
