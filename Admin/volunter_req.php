    ...
    <div class="container">
        ...
        <div class="main-content">
            ...
            <table id="main">
                <tr>
                    <td id="header">
                        <h1>Volunteer's Request Data</h1>
                    ...
                    <td>
                        <table>
                            <tr>
                                <th width="15%">Name</th>
                                <th width="20%">City</th>
                                <th width="20%">Motivation</th>
                                <th width="10%">Volunteer_Exp</th>
            ...
            <script type="text/javascript">
                $(document).ready(function () {
                    ...
                    function loadTable() {
                        $.ajax({
                            url: 'http://localhost/bhoorifoundation/admin/apis/api-fetch-all.php?table=volunteers',
                            type: "GET",
                            success: function (data) {
                                ...
                                if (data.length > 0) {
                                    ...
                                    $.each(data, function (index, item) {
                                        ...
                                        html += "<td>" + item.volunteer_experience + "</td>";
                                        html += "<td>" + item.skills + "</td>";
                    ...
                    $(document).on("click", ".delete-btn", function () {
                        if (confirm("Do you really want to approve this request?")) {
                            ...
                            var tableName = "volunteers"; // Set the correct table name here
                    ...
                    $("#search").on("keyup", function () {
                        ...
                        $.ajax({
                            url: 'http://localhost/bhoorifoundation/admin/apis/api-search.php?table=volunteers&search=' + search_term,
                            type: "GET",
                            success: function (data) {
